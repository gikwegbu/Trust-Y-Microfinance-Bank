...
<div class='content_customer'>
    ...
    <table align="center">
                    ...
                    try{ $sql="SELECT * FROM passbook".$sender_id." WHERE transactiondate BETWEEN '$date1' AND '$date2'";
                         $result=  $conn->query($sql);}catch(PDOException $e){
    echo "error in retrieving transactions";
                      }
