...
e.preventDefault();
	...
	$('.first-hanger-container').css('visibility','visible');
			$('.first-hanger-column').html(response);
		}
	})
})
...
$('.messageperson').click(function(e){
e.preventDefault();
	var id=$(this).attr('id');
	var qstring='messageperson='+id;
...
alert('success');
	$.ajax({
		...
		success:function(response){
			...
			$('.second-hanger-column').html(response);
		}
	})
})
