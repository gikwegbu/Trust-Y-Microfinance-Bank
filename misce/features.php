...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Features - What We Offer</title>
        <style>
            .content_customer ul{
                margin-left:150px;
                margin-top:50px;
        ...
        <div class='content_customer'>
             <h3 style="text-align:center;color:#2E4372;"><u>What this App can do</u></h3>
           <ul class="list-group">
               <li class="list group-item">Registration for online banking. </li>
               
               <li class="list group-item">Property purchase.</li>
               
               <li class="list group-item">Obtaining of loans with agreed conditions.</li>
               
               
               <li>Adding Beneficiary account by customer.</li>
                <li> Transferring amount to the beneficiary added by customer. </li>
               <li>Staff must approve for beneficiary activation before it can be used for transferring funds. ensuring security </li>
