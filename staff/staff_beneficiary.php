...
$result= $conn->query($sql);
	...
	echo 'failed in getting beneficiaries '.$e->getMessage();
}
?>
           
           <form action="staff_approve_beneficiary.php" method="POST">
<table align="center">
                        <th>id</th>
                        <th>Sender</th>
            ...
            <table align="center">
                        <tr>
                            <td>
                                <input type="submit" name="approve_beneficiary" value="Approve" class='addstaff_button'/>
                            </td>
                        </tr>
                    </table>
               </form>
